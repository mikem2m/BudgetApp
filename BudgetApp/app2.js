...
var controller = (function(budgetCtrl,UICtrl){
    ...
    var setupEventListener = function(){
        ...
        document.querySelector(DOM.resetButton).addEventListener('click',resetAll);
    ...
    var updateBudget = function(){
        ...
        // 1. Calculate the new budget (internal)
        budgetCtrl.calculateBudget();

        // 2. return the budget
        var budget = budgetCtrl.getBudget();

        // 3. Display the budget (external)
    ...
    var resetAll = function(){
        var ans = prompt('Are you sure you want to reset all? [Input 0 to confirm]');
        if(ans === '0'){

            // 1. Delete all item from data structure
            budgetCtrl.deleteAll();

            // 2. Delete all item from user interface
            UICtrl.deleteAll();
